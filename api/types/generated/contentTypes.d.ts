...
export interface ApiGordoGordo extends Schema.CollectionType {
  collectionName: 'gordos';
  info: {
    singularName: 'gordo';
    pluralName: 'gordos';
    displayName: 'Gordo';
...
export interface ApiSlimeSlime extends Schema.CollectionType {
  ...
  attributes: {
    ...
    FavouriteFood: Attribute.Relation<
      'api::slime.slime',
      'oneToOne',
      'api::food.food'
    >;
